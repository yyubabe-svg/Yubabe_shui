...
from app.api.routes import documents, qa, review, projects, flood, admin, upload, iso, usage, payment, cad, agent, workspace, tools, phase3
...
app.include_router(flood.router, prefix="/api/flood", tags=["防汛预案"])
...
app.include_router(cad.router, prefix="/api/cad", tags=["智能CAD"])
